...
<body>
	...
	<input type="text" id="adresseClient" name="adresseClient" value="<c:out value="${commande.client.adresse }"/>"
		size="20" maxlength="20" />
	...
	<input type="email" id="emailClient" name="emailClient" value="<c:out value="${commande.client.email }"/>"
